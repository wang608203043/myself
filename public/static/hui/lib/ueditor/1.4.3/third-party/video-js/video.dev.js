 ...
 * @param  {Element|Object}   elem Element or object to member listeners to
 * @param  {String}   type Type of event to member to.
 ...
 * @param  {*}   context The object to member as scope
...
vjs.bind = function(context, fn, uid) {
  ...
  // when using this, you need to use the member method when you remove the listener as well.
...
vjs.Slider = vjs.Component.extend({
  ...
  init: function(player, options){
    ...
    // this.player_.one('timeupdate', vjs.member(this, this.update));
...
vjs.LoadingSpinner = vjs.Component.extend({
  ...
  init: function(player, options){
    ...
    // player.on('stalled', vjs.member(this, this.show));
...
vjs.Player.prototype.addTextTrack = function(kind, label, language, options){
  ...
  // if (track.dflt()) {
  //   this.ready(vjs.member(track, track.show));
  // }
...
vjs.TextTrack.prototype.activate = function(){
  ...
  if (this.mode_ === 0) {
    ...
    // Using unique ID for member function so other tracks don't remove listener
