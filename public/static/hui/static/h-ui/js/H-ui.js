...
(function(factory) {
	...
	/*
			...
			to member your own submit handler to the form.  For example,
...
!function($) {
	...
	// BUTTON DATA-API
	// ===============
	$(document).on('click.bs.button.data-wx', '[data-toggle^="button"]',
	function(e) {
		var $btn = $(e.target);
		if (!$btn.hasClass('btn'));
		$btn = $btn.closest('.btn');
		...
		e.preventDefault();
	}).on('focus.bs.button.data-wx blur.bs.button.data-wx', '[data-toggle^="button"]',
	function(e) {
...
!function($) {
	...
	// MODAL DATA-API
	// ==============
	$(document).on('click.bs.modal.data-wx', '[data-toggle="modal"]',
	function(e) {
		var $this = $(this);
...
!function($) {
	...
	$(document).on('click.bs.dropdown.data-wx', clearMenus).on('click.bs.dropdown.data-wx', '.dropdown form',
	function(e) {
		e.stopPropagation()
	}).on('click.bs.dropdown.data-wx', toggle, Dropdown.prototype.toggle).on('keydown.bs.dropdown.data-wx', toggle, Dropdown.prototype.keydown).on('keydown.bs.dropdown.data-wx', '.dropdown-menu', Dropdown.prototype.keydown);
} (window.jQuery);
$(function() {
	/*下拉菜单*/
...
!function($) {
	...
	// ALERT DATA-API
	// ==============
	$(document).on('click.bs.alert.data-wx', dismiss, Alert.prototype.close)
} (window.jQuery);
...
! (function(factory) {
	...
	*/
	...
	$(document).on('focus.datetimepicker.data-wx click.datetimepicker.data-wx', '[data-provide="datetimepicker"]',
	function(e) {
		var $this = $(this);
